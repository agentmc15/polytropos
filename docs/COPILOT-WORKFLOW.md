...
`cached_date` **2026-09-21** — the pins and their tiers came through that refresh unchanged, though
`claude-fable-5` now shares the frontier tier with `claude-fable-5.1` — the pins were:
`architect` → `claude-fable-5` (frontier — kit
