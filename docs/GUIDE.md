...
[ASSESSMENTS/polytropos-decision-improvement-v1.md](ASSESSMENTS/polytropos-decision-improvement-v1.md).
...
- `bin/exec_policy.py check` — what OS execution boundary this host actually enforces (exit 3 if
  ...
  **refuses rather than downgrading**; Linux and Windows have no backend, so verification there needs
  ...
  confined. [SECURITY.md](../SECURITY.md) is the authority on what that does and does not promise —
...
repository is [ASSESSMENTS/polytropos-decision-improvement-v1.md](ASSESSMENTS/polytropos-decision-improvement-v1.md)
