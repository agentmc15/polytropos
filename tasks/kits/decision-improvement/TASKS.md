# Codex planning mirror — not the Claude execution status authority

This is a planning-time projection. Use the native Claude kit for the requested execution; do not run both copies. If Codex execution is selected later, reconcile status and phase requirements before dispatch.
