...
<!-- GENERATED by bin/docs_build.py from skills/route/SKILL.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->
...
- **Source:** [skills/route/SKILL.md](https://github.com/agentmc15/polytropos/blob/main/skills/route/SKILL.md)
- **Also available on:** [OpenAI Codex CLI](../codex/route.md), [GitHub Copilot CLI](../copilot/route.md)
- **References shipped with the skill:** [references/pricing.json](https://github.com/agentmc15/polytropos/blob/main/skills/route/references/pricing.json)
