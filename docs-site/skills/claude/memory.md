...
<!-- GENERATED by bin/docs_build.py from skills/memory/SKILL.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->
...
- **Source:** [skills/memory/SKILL.md](https://github.com/agentmc15/polytropos/blob/main/skills/memory/SKILL.md)
- **Also available on:** [OpenAI Codex CLI](../codex/memory.md)
