...
<!-- GENERATED by bin/docs_build.py from skills/architect/SKILL.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

> Have Fable 5 do the expensive meta-work once — deep plan a complex task (codebase review, greenfield project, large migration) AND build the execution kit (task briefs, model-pinned subagents, skills, verification loops) so Opus/Sonnet can execute at near-Fable quality. Use when the user says "plan this with Fable", "architect this", "review this codebase", or escalates a complex task.

- **Source:** [skills/architect/SKILL.md](https://github.com/agentmc15/polytropos/blob/main/skills/architect/SKILL.md)
- **Also available on:** [OpenAI Codex CLI](../codex/architect.md), [GitHub Copilot CLI](../copilot/architect.md)
- **References shipped with the skill:** [references/roles/docs-editor.md](https://github.com/agentmc15/polytropos/blob/main/skills/architect/references/roles/docs-editor.md), [references/roles/red-team.md](https://github.com/agentmc15/polytropos/blob/main/skills/architect/references/roles/red-team.md), [references/roles/scout.md](https://github.com/agentmc15/polytropos/blob/main/skills/architect/references/roles/scout.md), [references/roles/second-verifier.md](https://github.com/agentmc15/polytropos/blob/main/skills/architect/references/roles/second-verifier.md), [references/roles/security-auditor.md](https://github.com/agentmc15/polytropos/blob/main/skills/architect/references/roles/security-auditor.md), [references/roles/synthesizer.md](https://github.com/agentmc15/polytropos/blob/main/skills/architect/references/roles/synthesizer.md), [references/roles/test-author.md](https://github.com/agentmc15/polytropos/blob/main/skills/architect/references/roles/test-author.md)
