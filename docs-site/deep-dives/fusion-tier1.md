<!-- GENERATED by bin/docs_build.py from docs/FUSION-TIER1.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

# Fusion Tier 1 — multi-model orchestration borrows

!!! note
    Mirrored from `docs/FUSION-TIER1.md` — edit the source, then run `python3 bin/docs_build.py build`.
