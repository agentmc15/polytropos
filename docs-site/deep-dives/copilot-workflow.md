<!-- GENERATED by bin/docs_build.py from docs/COPILOT-WORKFLOW.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

# The Copilot workflow layer

!!! note
    Mirrored from `docs/COPILOT-WORKFLOW.md` — edit the source, then run `python3 bin/docs_build.py build`.
