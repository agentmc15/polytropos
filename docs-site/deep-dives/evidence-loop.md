<!-- GENERATED by bin/docs_build.py from docs/EVIDENCE-LOOP.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

# Evidence-Loop: Measuring Governance, Promotion, and Escalation Quality

!!! note
    Mirrored from `docs/EVIDENCE-LOOP.md` — edit the source, then run `python3 bin/docs_build.py build`.
