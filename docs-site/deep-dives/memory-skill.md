<!-- GENERATED by bin/docs_build.py from docs/MEMORY-SKILL.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

# Memory skill

!!! note
    Mirrored from `docs/MEMORY-SKILL.md` — edit the source, then run `python3 bin/docs_build.py build`.
