<!-- GENERATED by bin/docs_build.py from docs/COPILOT-PARITY.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

# Copilot CLI parity — the Claude Code plugin experience, ported

!!! note
    Mirrored from `docs/COPILOT-PARITY.md` — edit the source, then run `python3 bin/docs_build.py build`.
