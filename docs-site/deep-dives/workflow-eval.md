<!-- GENERATED by bin/docs_build.py from docs/WORKFLOW-EVAL.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

# Workflow evaluation

!!! note
    Mirrored from `docs/WORKFLOW-EVAL.md` — edit the source, then run `python3 bin/docs_build.py build`.
