<!-- GENERATED by bin/docs_build.py from docs/COPILOT-COSTVIZ.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

# Copilot cost visibility

!!! note
    Mirrored from `docs/COPILOT-COSTVIZ.md` — edit the source, then run `python3 bin/docs_build.py build`.
