<!-- GENERATED by bin/docs_build.py from docs/CODEX-HARNESS.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

# The Codex harness

!!! note
    Mirrored from `docs/CODEX-HARNESS.md` — edit the source, then run `python3 bin/docs_build.py build`.
