<!-- GENERATED by bin/docs_build.py from docs/COPILOT-PINS.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

# Copilot model prefs — pinning and excluding models

!!! note
    Mirrored from `docs/COPILOT-PINS.md` — edit the source, then run `python3 bin/docs_build.py build`.
