<!-- GENERATED by bin/docs_build.py from docs/PER-TASK-DOLLARS.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

# Per-task dollars — attributing delegated cost by task and role

!!! note
    Mirrored from `docs/PER-TASK-DOLLARS.md` — edit the source, then run `python3 bin/docs_build.py build`.
