<!-- GENERATED by bin/docs_build.py from docs/AESOP-INTEGRATION.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->
...
The operative text lives in [`skills/architect/SKILL.md`](https://github.com/agentmc15/polytropos/blob/main/skills/architect/SKILL.md) (the
