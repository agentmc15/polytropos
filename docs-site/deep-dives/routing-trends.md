<!-- GENERATED by bin/docs_build.py from docs/ROUTING-TRENDS.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

# Routing trends — cross-repo history and the snapshot time series

!!! note
    Mirrored from `docs/ROUTING-TRENDS.md` — edit the source, then run `python3 bin/docs_build.py build`.
