<!-- GENERATED by bin/docs_build.py from docs/CONTEXT-WEIGHT.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

# Context weight

!!! note
    Mirrored from `docs/CONTEXT-WEIGHT.md` — edit the source, then run `python3 bin/docs_build.py build`.
