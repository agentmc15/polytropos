<!-- GENERATED by bin/docs_build.py from docs/ROUTING-HISTORY.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

# Routing history — the cross-kit per-tier track record

!!! note
    Mirrored from `docs/ROUTING-HISTORY.md` — edit the source, then run `python3 bin/docs_build.py build`.
