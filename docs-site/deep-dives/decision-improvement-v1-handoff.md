<!-- GENERATED by bin/docs_build.py from docs/DECISION-IMPROVEMENT-V1-HANDOFF.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

# Decision and improvement — Release 1 handoff

!!! note
    Mirrored from `docs/DECISION-IMPROVEMENT-V1-HANDOFF.md` — edit the source, then run `python3 bin/docs_build.py build`.
