<!-- GENERATED by bin/docs_build.py from docs/FUSION-TIER2.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

# Fusion Tier 2 — dynamic mid-kit re-routing behind an autonomy dial

!!! note
    Mirrored from `docs/FUSION-TIER2.md` — edit the source, then run `python3 bin/docs_build.py build`.
