<!-- GENERATED by bin/docs_build.py from docs/HOW-IT-WORKS.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

# How polytropos works

!!! note
    Mirrored from `docs/HOW-IT-WORKS.md` — edit the source, then run `python3 bin/docs_build.py build`.

An in-depth walkthrough of the plugin's architecture, the reasoning behind it, and every component's mechanics. Companion HTML version: `how-it-works.html`.
...
decisions that has to make, one place each, and [SECURITY.md](https://github.com/agentmc15/polytropos/blob/main/SECURITY.md) is the authority on
