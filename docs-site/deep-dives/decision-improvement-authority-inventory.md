<!-- GENERATED by bin/docs_build.py from docs/DECISION-IMPROVEMENT-AUTHORITY-INVENTORY.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

# Decision and improvement — authority inventory

!!! note
    Mirrored from `docs/DECISION-IMPROVEMENT-AUTHORITY-INVENTORY.md` — edit the source, then run `python3 bin/docs_build.py build`.
