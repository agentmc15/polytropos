<!-- GENERATED by bin/docs_build.py from docs/NEXT-DAY-RUNBOOK.md — do not edit; edit the source and run: python3 bin/docs_build.py build -->

# Next-day runbook

!!! note
    Mirrored from `docs/NEXT-DAY-RUNBOOK.md` — edit the source, then run `python3 bin/docs_build.py build`.
