...
class RealTreeIdempotenceTests(unittest.TestCase):
    ...
    once step 26 added docs/RELEASE.md, 74/75 once D01 and D03 added their two
    docs/DECISION-IMPROVEMENT-*.md sources, 76 once D25 added the
    ...
    (2026-09-21), then 84 when the Codex skill parity ports added five pages, and 85 once docs/REFERENCE.md took the long-form page out of README.md
    (2026-09-24) -- this test derives the count dynamically for the
    ...
    def test_build_twice_on_the_full_real_roster(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(expected_count, 85, "the pinned page-set size (85 total)")
