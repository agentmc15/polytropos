...
`primitives/harness-capabilities.json`); as of this writing the latter exists for Claude Code only
(one live run and one review on a throwaway kit, 2026-09-16), and every unrun live check is
listed there as prepared, not done.
