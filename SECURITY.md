...
`primitives/harness-capabilities.json`); as of this writing the latter exists for one Claude Code
invocation and nothing else, and every unrun live check is listed there as prepared, not done.
